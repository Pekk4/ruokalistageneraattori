...
class TestRepository(unittest.TestCase):
    ...
    def test_find_all_meals_returns_correct_object(self):
        ...
        self.assertIs(value, self.return_on_select_query_mock.fetchall())
